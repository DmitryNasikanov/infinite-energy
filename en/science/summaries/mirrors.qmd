...
Swarm Mirrors are the core element of the [Dyson Swarm](../reference/glossary.qmd#dyson-swarm) project. Approximately 1.1 billion autonomous reflectors in orbit around the Sun collect and redirect solar energy to Earth.
...
| [Mass Drivers](../reference/glossary.qmd#mass-driver) | ~1,000 |
...
The Swarm directs energy to **[Lunar Solar Power stations (LSP)](../reference/technology-readiness.qmd#lsp-station)**.
...
> **Conclusion:** An orbital Hub is [economically unfeasible](../detailed/hub.qmd) — half the efficiency and massive radiators in space.
...
### Optical Cluster Control {#optical-cluster-control}

The "Mother-Children" architecture **reduces electronics import by 98%**.

#### The Problem

With individual control, each mirror requires a full 50 g chip:
- 1.1 billion mirrors × 50 g = **55,000 tons** of electronics from Earth
- ~6,250 tons/year = ~125 Starship launches/year

#### Solution: Mother Mirrors + Child Mirrors

| Role | Electronics | Quantity | Mass/unit | Import |
|------|-------------|----------|-----------|--------|
| **Mother** (leader) | Full chip | 1.1 M | 50 g | **55 t** |
| **Children** (followers) | Simple decoder | 1.1 B | 2 g | **2,200 t** |
| **TOTAL** | | | | **2,255 t** |

**Savings: 55,000 t → 2,255 t = 96%** (24× less)

#### How It Works

**Mother mirror** (1 per ~1,000 Children):
- Star tracker — determines cluster orientation
- Processor — calculates commands for Children
- Laser transmitter — modulated beam to Children
- Radio — communication with Earth/other Mothers

**Child mirrors** (passive):
- Photodiode (~2 g) — receives optical signal from Mother
- Simple decoder — converts signal to electrochromic commands
- No processor — only analog/digital logic

```
Control Protocol:

Mother → [modulated light] → Children

Commands (example):
├─ 1 ms pulse: "edge A activate"
├─ 2 ms pulse: "edge B activate"
├─ 3 ms pulse: "all off"
└─ Pulse series: encodes angle/speed
```

#### Hybrid Implementation

| Phase | Years | Technology | Import |
|-------|-------|------------|--------|
| 1 | 7-10 | Import 2 g decoders | ~1,000 t |
| 2 | 10+ | Local analog receivers | **0 t** |

**Phase 2:** [Blue Alchemist](../reference/technology-readiness.qmd#in-situ-silicon-cells) technology (TRL 5-6) enables production of silicon photodiodes from lunar/Mercurian regolith. Resonant LC circuits (coils + capacitors) are made from local aluminum and Al₂O₃ ceramics.

**Total import:** ~1,055 t (instead of 55,000 t) = **98% savings**

> **Technology baseline:** [Laser inter-satellite links](https://ts2.tech/en/laser-wars-in-orbit-the-2024-2030-boom-in-optical-inter-satellite-links/) (China, 2024-2025) — 400 Gbps optical communication between satellites. [Leader-follower formation](https://www.sciencedirect.com/science/article/abs/pii/S0094576520301430) — swarm control via optical navigation. IKAROS (2010) — electrochromics on solar sails.
...
Exponential factory growth (1->~1,650) and Mass Driver scaling (1->1,000) over 4 years, then full capacity of 219 million mirrors/year. Detailed calculation: [Scaling](../detailed/railguns/scaling.qmd), [Roadmap](roadmap.qmd).
:::
...
> **How TiO₂ is extracted:** Titanium (<1% in crust) is extracted from ilmenite (FeTiO₃) by magnetic separation, then separated from iron by oxidative roasting. Details: [Titanium Line](../detailed/materials/titanium.qmd).
...
With [Mother-Children architecture](#optical-cluster-control), import is reduced by 98%:
...
**Comparison:**
- Without optimization: 1.1 B × 50 g = **55,000 t** = ~1,100 Starship
- With Mother-Children architecture: **~1,055 t** = **~21 Starship**

**Savings: 98%** (53× fewer launches)

> **Note:** Phase 2 (years 10+) uses [Blue Alchemist](../reference/technology-readiness.qmd#in-situ-silicon-cells) technology for local production of silicon photoreceivers from regolith.
...
**Details:** [Ground Zero Factory](../detailed/factories/overview.qmd)

---

## Mass Driver Launch

Mirrors are launched into space by electromagnetic catapult — [Mass Driver](../detailed/railguns/overview.qmd).
...
*At reduced load: 2-3 km (425-637g). See [MD Theory](../detailed/railguns/theory.qmd).
...
- [Mass Driver: Theory](../detailed/railguns/theory.qmd) — detailed launch calculations
