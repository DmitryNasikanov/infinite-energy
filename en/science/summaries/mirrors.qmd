...
> **Why this architecture?** Individual chips per mirror = 55,000 t import. With Mother-Children architecture: **~1,055 t** — **98% savings**. Details: [Earth Import](#earth-import).
...
> **Technology baseline:** [NASA DSOC](https://www.nasa.gov/mission/deep-space-optical-communications-dsoc/) (2024) — optical communication at 140 million miles. [Sprites](https://spectrum.ieee.org/exploring-space-with-chipsized-satellites) (Cornell) — 4g satellite for $50.
...
> **Why the Moon, not an orbital hub?** See [detailed analysis](../detailed/hub.qmd#why-on-the-moon-not-in-orbit) — 18% vs 10% efficiency, no radiators in space.

### Swarm Energy Distribution

The Swarm produces ~20 PW. Distribution:

| Purpose | Power | % of Swarm | Note |
|---------|-------|------------|------|
| **Earth** | 1 PW | 5% | **50× current consumption** (20 TW) |
| **Mars** | 1-5 PW | 5-25% | Terraforming (future) |
| **Moon** | 0.5 PW | 2.5% | Local production |
| **Reserve** | 13-17 PW | 65-85% | Expansion, buffer |

> **Details:** [Energy Distribution](../detailed/hub.qmd#energy-distribution)
...
Exponential factory growth (1->~1,650) and Mass Driver scaling (1->1,000) over 4 years, then full capacity of 219 million mirrors/year. Detailed calculation: [Scaling](../detailed/railguns/overview.qmd), [Roadmap](roadmap.qmd).
:::
...
*At reduced load: 2-3 km (425-637g). See [MD Theory](../detailed/railguns/overview.qmd).
...
- [Mass Driver: Theory](../detailed/railguns/overview.qmd) — detailed launch calculations
