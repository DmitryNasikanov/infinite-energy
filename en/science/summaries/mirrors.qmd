...
> **Why this architecture?** With individual chips on each mirror, electronics import = 1.1 billion × 50 g = **55,000 tons**. With Mother-Children architecture: 1.1 million × 50 g + 1.1 billion × 2 g = **~2,255 tons** — **96% savings**.

> **Technology baseline (2025):** [Laser inter-satellite links](https://ts2.tech/en/laser-wars-in-orbit-the-2024-2030-boom-in-optical-inter-satellite-links/) (China, 2024-2025) — optical communication between satellites. [Leader-follower formation](https://www.sciencedirect.com/science/article/abs/pii/S0094576520301430) — swarm control via optical navigation. IKAROS (2010) — electrochromics on solar sails.
...
Mother → [modulated laser] → Children

Commands (example):
├─ 1 ms pulse: "edge A on"
├─ 2 ms pulse: "edge B on"
├─ 3 ms pulse: "all off"
└─ Pulse series: encodes angle/speed
```

The photodiode on the Child decodes pulses and directly controls electrochromic strips — no processor needed.
...
### Transition to Local Electronics Production {#optical-cluster-control}

The Mother-Children architecture (described in [Construction](#two-types-of-mirrors-mother-and-children) section) enables gradual phase-out of imports:
