...
| Parameter | Value |
|-----------|-------|
| Factory consumption | 55 MW |
| 100 mirrors -> Moon | 9,300 MW reflected |
...
|--------|---------|------|
| Delivery | $155M | **$93M** ✓ |
| Mass Driver | Harder (1275g) | **Simpler (25g)** ✓ |
...
> **The Moon is a serious alternative.** Technically simpler, cheaper for iterations, but scales slower and requires solving decommissioning. Optimal: Moon as testbed (years 4-6), then Mercury for scaling.
...
| Mass Driver | ✓ (1275g) | ✗ (atmosphere) | **✓ (25g, simpler)** |
