...
> - **Power consumption:** 55 MW for the complex - **168 MW available** (6 trips of CPV system: concentrators + GaAs)
...
| **Available energy (6 CPV trips)** | **168 MW** (113 MW reserve) |

> **Note:** 5 MW is the energy of the factory itself (smelting, MRE, rolling). The full complex with Mass Driver (~39 MW) consumes 55 MW. The CPV system (105,000 m² concentrators + GaAs cells, ~10.5 t) delivers 168 MW at Mercury (16 kW/kg) — a 113 MW reserve for scaling. See [detailed calculation](#power-consumption-of-1-complex).
...
- 6 shipments of CPV system = **168 MW** (~10.5 t: Kapton+Al concentrators + GaAs + structure)
...
- Fe for robots: 5 x ~560 kg = **~2.8 t/day** (of 11 t available)
