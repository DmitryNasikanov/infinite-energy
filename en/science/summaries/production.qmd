...
The purpose of this documentation is to confirm the **fundamental feasibility** of the project and provide preliminary estimates for budgets and timelines. Calculations confirm: all necessary technologies exist ([MRE](../reference/technology-readiness.qmd#mre-electrolysis) electrolysis, WAAM, solar concentration, electromagnetic launch), materials on Mercury are present in sufficient quantities (Al, Fe, Si, Ti, S), and delivery logistics are realistic given current launch cost trends.
...
| Mass Drivers | 1,000 | 450 t | **0.45 million t** |
...
Preparatory phases (R&D, Earth and Moon testbeds) are described in the [Roadmap](roadmap.qmd).
...
>
> **First factory assembly:** [Bootstrap](../reference/glossary.qmd#bootstrap) — checkpoint model, assembly scenarios
