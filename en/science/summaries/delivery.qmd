...
**Moon:** [LSP station](../detailed/hub.qmd) production from local resources (regolith to aluminum, silicon). Only "Vitamins" delivered from Earth — electronics, optics, rare materials. Production details: [Ground Zero Factory](../detailed/factories/overview.qmd).
