...
| Actuators (16 pcs: 4 wheels + 2×4 direct-drive + 2×2 tendon) | Fe + Al + NdFeB | 25 kg | [Actuators](../elements/actuators.qmd) |
...
**4 wheels:**
- Diameter: Ø1.2 m (unified with Mole-M/Crab-M)
- Width: 0.6 m
- Material: Al rim + Fe-6%Mn band (local)
- Drive: Electric motors 2 kW × 4 = 8 kW + [cycloidal gearbox](../elements/actuators.qmd#electric-actuators) 1:20
...
2. Mount 2 kW electric motors with cycloidal gearboxes 1:20
3. Install wheels
...
- Joints 1-4: [direct-drive](../elements/actuators.qmd#electric-actuators) (NdFeB magnets, import) — zero backlash, zero gearbox maintenance
- Joints 5-6 (wrist): [tendon drives](../elements/actuators.qmd#electric-actuators) — motor on body, wire through pulleys (100% local materials)

**Installation process:**
1. Mount manipulator base on frame (M20 bolts)
2. Install 6 manipulator links (each link — 200 mm)
3. Install 4 direct-drive motors (joints 1-4) + 2 tendon drives (joints 5-6)
