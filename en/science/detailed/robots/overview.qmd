...
| **Crab-M** | ~1000 kg | Fe 35% + Al 47% | [NaS](../reference/technology-readiness.qmd#nas-batteries) 20 kWh | 10 kW | Logistics, MD buffer |
| **Centaur-M** | ~380 kg | Fe 22% + Al 63% | NaS 5 kWh + cable | 5 kW | Assembly, maintenance |
| **Average** | ~960 kg | Fe 58% + Al 32% | — | — | — |

*Crab-M (~1000 kg): frame ~800 kg + NaS battery ~150 kg + actuators ~40 kg + sensor housings ~20 kg + electronics (chips) ~0.5 kg ≈ 1010 kg. Mole-M: cable reel 50 m, cross-section 50 mm² Al, 10 kV → 400 V (transformer). Details: [Mole-M Assembly](assembly/moles.qmd)*
...
### Import Components ("[vitamins](../reference/glossary.qmd#vitamins)")
...
>99% by mass — local production; import components are part of "vitamins". Details: [Actuators](elements/actuators.qmd#ball-bearings-high-speed-shafts).
...
|-----------|-----------|----------|
| MoS₂ bearing recoating | 3-6 months | [Magnetron station](elements/actuators.qmd#critical-component-equipment) + Centaur-M |
