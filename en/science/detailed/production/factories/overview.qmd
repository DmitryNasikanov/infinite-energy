...
> - **Size:** Dome ~1,500 m^2 (~50x30 m), height 6-8 m, atmosphere 0.1 atm N2
...
**More on preparation:** [Roadmap](../../../summaries/roadmap.qmd)
...
flowchart TD
    ...
    subgraph DOME["F-R Dome (0.1 atm N2, +25C)"]
...
flowchart TD
    ...
    subgraph DOME["F-M Dome (0.1 atm N2, +25C)"]
        subgraph CASTING["Casting (200 m2)"]
            TUNDISH["Tundish"]
            MNLZ["CCM-Al"]
        end
...
- [Energy System](../../production.qmd#energy) - energy for production
