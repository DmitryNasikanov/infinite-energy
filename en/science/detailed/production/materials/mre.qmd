...
> **Note:** These are **ground-based** concentrator mirrors on Mercury's surface, not to be confused with the orbital Dyson Swarm. The first mirror set (~1 t, Kapton) is delivered from Earth, then produced locally from aluminum. See [Production](../../production.qmd#energy).
...
| Method | Description |
| :--- | :--- |
| Argon blowing (**import**) | Gas bubbles capture non-metallic inclusions |
