...
### Why Vacuum Is Not a Problem for Glass?

**Potential concern:** evaporation of alkalis (Na, K) at 1400C in vacuum.

**Why this is not a problem:**

1. **Mercury silicate composition is similar to E-glass** — alkali content < 1%
2. **SiO₂ vapor pressure** — only 10⁻⁴ Torr at 1025C (very low)
3. **Fast process** — melt passes through bushings in seconds
4. **ESA research** — fibers in vacuum may be **stronger** due to absence of hydrolytic weakening

### Design: Hermetic Crucible

For reliability, a closed system is used:

| Element | Material | Purpose |
| :--- | :--- | :--- |
| Crucible | MgO ceramics (local) | Melting in sealed volume |
| Bushings | Tungsten (local) | Only bushing zone exposed to vacuum |
| Cooling | Radiation to vacuum | Rapid fiber cooling |

> **Note:** The closed crucible minimizes melt exposure to vacuum. The fiber cools instantly through radiative heat transfer in vacuum.
