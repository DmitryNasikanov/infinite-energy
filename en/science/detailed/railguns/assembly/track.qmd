...
> - **Time:** 2-3 months for first MD, 1-2 months for subsequent ones
...
| **TOTAL** | **~2-3 months** | peak 50 | |

**With experience (subsequent MDs):** ~**1-2 months**
...
| Diameter | Ø20 mm |
| Radiators | ~1700 m² (directed into shadow) |
...
| Sensors | 200 (current, temperature, position) |
...
| Electronics | ~3 t | **Earth Import** |
| Sulfur-concrete (supports) | ~100 t | Local (regolith + sulfur) |
| **TOTAL** | **~450 t** | **99.3% local** |

*With extension: 2 km (~875 t), 3 km (~1300 t).*
