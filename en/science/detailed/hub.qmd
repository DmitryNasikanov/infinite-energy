...
> - **Solution:** Lunar Solar Power Station ([LSP](../reference/technology-readiness.qmd#lsp-station)) — 40 stations on the Moon's limbs
...
The Dyson Swarm is **capacity** of ~21 PW (at Earth, after all losses). LSP Phase 1 is sized to receive from **5% of the Swarm** (~55 million mirrors), delivering **1 PW** to Earth. Power distribution:

| Stage | Recipient | Power | Notes |
|-------|-----------|-------|-------|
| **Swarm capacity** | **(full)** | **~21 PW** | **1.1 billion mirrors** |
...
- **Buffer:** [NaS](../reference/technology-readiness.qmd#nas-batteries) batteries for peak load smoothing
