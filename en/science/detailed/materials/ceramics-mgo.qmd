...
> - **Input:** 48 t/day liquid Mg from distillation + 32 t/day O2 from MRE
> - **Output:** ~70 t/day MgO ceramics (88% yield)
...
| Parameter | Value |
|-----------|-------|
| Input | Liquid Mg from distillation (48 t/day, 8% of regolith) |
| Input | O2 from MRE electrolysis (32 t/day) |
| Output | MgO ceramic blocks/powder (~70 t/day) |
...
flowchart TD
    subgraph INPUT["INPUT"]
        MG["Liquid Mg<br/>1091C<br/>48 t/day"]
...
| Incoming Mg | 48 t/day = 1,975 kmol/day |
| Required O2 | 32 t/day = 987.5 kmol/day |
| Outgoing MgO (theoretical) | 79.6 t/day |
...
**Oxygen source:** MRE electrolysis produces ~1500 t O2/day when decomposing regolith oxides (SiO2, FeO, Al2O3). For MgO only 32 t/day is needed -- the excess is vented to atmosphere or stored for other purposes.
...
|-----------|--------|----------|------------|----------|
| Mg (input) | -> | 48 t/day | 24.3 kg/kmol | 1,975 |
| O2 (input) | -> | 32 t/day | 32 kg/kmol | 987.5 |
| MgO (theoretical) | <- | 79.6 t/day | 40.3 kg/kmol | 1,975 |
| **MgO (actual)** | **<-** | **~70 t/day** | **88% yield** | **1,738** |
...
2. **Oxygen surplus** -- MRE produces ~1500 t O2/day, we use only 32 t
3. **Free heat** -- solar furnace runs on concentrated sunlight (1 MW/m2 at surface)
4. **Magnesium in regolith** -- 8% content, distillation yields 48 t/day pure Mg
