...
[Bootstrap](../reference/glossary.qmd#bootstrap-блиц-монтаж) is the only moment in the project when there are no local resources and nowhere to charge robots. After factory startup, standard production with self-replication begins.
...
|-----------|--------|-------|---------------|--------|
| A1. Unload energy modules | [Crab-Z](../reference/glossary.qmd#поколение-1-gen-1) ×12 | 2 | - | Modules in position |
| A2. Deploy panels | [Spider-Z](../reference/glossary.qmd#поколение-1-gen-1) ×16 | 4 | B1 | 5 MW available |
| A3. Lay cables | [Centaur-Z](../reference/glossary.qmd#поколение-1-gen-1) ×8 | 4 | B1 | Power system |
...
| **Dome Module** | 4.0 t | Shell + airlock + ladle + internal radiators |
| **CCM Module** | 6.0 t | Crystallizer + stand + roller table (on skids) |
| **Rolling Module** | 10.0 t | Mill (6 stands) + drawing + winding |
| **Finishing Module** | 6.0 t | WAAM + CNC + assembly jig + manipulators |
...
| Power (near Mercury) | ~500 kW |
| Total battery capacity (56 robots) | ~100 kWh |
| Full charge time | ~12 minutes (at full power) |
...
| C4.3 | Install [WAAM](../reference/technology-readiness.qmd#waam-3d-печать) | Centaur-Z ×4 | 2 | C4.2 | 8 |
...
| E4.4 | Install electronics ([vitamins](../reference/glossary.qmd#витамины)) | Centaur-Z ×2 | 1 | E4.3 | 2 |
