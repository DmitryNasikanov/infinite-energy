...
::: {.callout-note}
## Timeline requires separate calculation
The exact schedule depends on factory cloning rate and Mass Driver production. Preliminary estimates are provided.
:::

### Production Capacity Growth

| Year | GZF | Mass Drivers | Mirrors/year |
|------|-----|--------------|--------------|
| 1 | 10-20 | ~50 | ~11 million |
| 2 | 50-100 | ~150 | ~33 million |
| 3 | 200-400 | ~400 | ~88 million |
| 4 | 800-1200 | ~900 | ~197 million |
| 5+ | **~1,500** | **1,000** | **219 million** |

**At 1,000 Mass Drivers (full capacity):**
```
1 MD = 600 mirrors/day = 219,000 mirrors/year
1,000 MD = 219 million mirrors/year
Each MD is served by ~1.5 GZF (400 mirrors/day × 1.5 = 600)
```
...
| Year | Produced | Replaced | Total | Power on Earth | × global |
|------|----------|----------|-------|----------------|----------|
| **1** | 11 M | — | 11 M | 0.21 PW | **10×** |
| 2 | 33 M | — | 44 M | 0.84 PW | 42× |
| 3 | 88 M | — | 132 M | 2.5 PW | 125× |
| 4 | 197 M | — | 329 M | 6.3 PW | 315× |
| 5 | 219 M | — | 548 M | 10 PW | 500× |
| 6 | 219 M | — | 767 M | 15 PW | 750× |
| **7** | 219 M | — | 986 M | **~19 PW** | **~1000×** |
| 8 | 219 M | — | 1.21 B | 23 PW | 1150× |
| 9 | 219 M | — | 1.42 B | 27 PW | 1350× |
| 10 | 219 M | — | 1.64 B | 31 PW | 1550× |
| 11 | 219 M | 11 M | 1.85 B | 35 PW | 1750× |
| 12 | 219 M | 33 M | 2.04 B | 39 PW | ~2000× |
...
>
> **In the first year alone** (0.21 PW) the project produces 10× global consumption!

> **Note:** "Replaced" = mirrors that failed after 10 years (equals production of that year).
> Total = previous total + produced − replaced.

### Key Milestones

- **Year 1:** 0.21 PW — already 10× global consumption
- **Year 7:** ~19 PW — 1000× global consumption, **~1.1 billion mirrors** target achieved
- **Year 11+:** growth slows due to replacement

### Long-term Balance

After year 11, net increase = 219 M − (production 10 years ago). By year 15, we reach a **plateau of ~2.2 billion mirrors** (~42 PW), when replacement equals production (219 M/year).

> **Why 1.1 billion?** ~21 PW = ~1000× global consumption — covers all civilization's energy needs, including Mars terraforming, fuel synthesis, and interstellar missions.
...
Detailed calculations: [Reflection Geometry](geometry.qmd)
...
- [Mercury](../summaries/mercury.qmd) — factory and self-replication
