...
| Glass fiber bushings | Al₂O₃ (local) | **Al₂O₃ ceramics** — [proven alternative to Pt-Rh](https://www.sciencedirect.com/science/article/abs/pii/0261306981900510) |
| CNC cutters | Need cutting tools | **Si₃N₄ ceramics** from Si + N₂ (minimal nitrogen import) |
...
| Coolant | Not required (vacuum, ceramics work in dry conditions) |
| Tooling | **Si₃N₄ ceramic cutters** (local production from Si + N₂) |
...
| Vitamins (factories) | Years 1-10 | ~77 kg/factory/year |
...
**Mirror electronics** — thanks to [Mother-Children architecture](mirrors.qmd#optical-cluster-control), import is reduced by **98%**:
