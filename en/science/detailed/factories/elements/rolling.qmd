...
> **Note: 50 μm is an intermediate semi-finished product.** Swarm mirrors require **4 μm** foil (see [Mirrors](../../../summaries/mirrors.qmd)). Finish rolling from 50 → 4 μm is performed on a dedicated foil mill (~8-10 additional passes at 30-40% reduction each). Industrial reference: Novelis/UACJ produce 4.5 μm foil commercially.
...
- At 15-20% reduction per pass: Ø20 → Ø1.6 mm requires 11-15 dies
...
- Intermediate annealing after 4-5 passes (strain relief)
