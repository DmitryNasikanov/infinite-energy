...
// Load data from JSON (shared with Russian version)
dataScript = FileAttachment("../../ru/science/data/db/data.json").json()
...
function unitWidget(unitId) {
  ...
  // Calculate totals ONLY for materials (not components!)
